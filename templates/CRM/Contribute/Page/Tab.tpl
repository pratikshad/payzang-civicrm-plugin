    ...
    <div class="view-content">
        <div id="help">
            {if $permission EQ 'edit'}
                ...
                {if $newCredit}
                    ...
                    {ts 1=$newCreditURL}Click <a href='%1'>Submit Contribution</a> to process a new contribution on behalf of the contributor using their credit card.{/ts}
                {/if}
            {else}
        ...
        {if $action eq 16 and $permission EQ 'edit'}
            <div class="action-link">
                ...
                {if $newCredit}
                    <a accesskey="N" href="{$newCreditURL}" class="button"><span><div class="icon add-icon"></div>{ts}Submit Contribution{/ts}</span></a>
                {/if}
                <br /><br />
            </div>
      <div class='clear'> </div>
